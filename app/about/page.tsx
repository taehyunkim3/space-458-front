  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-96 overflow-hidden">
        <Image
          src="https://via.placeholder.com/1920x800/f3f4f6/6b7280?text=Gallery+Exterior"
          ...
          <div className="text-center mb-16">
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-lg font-light">
                스페이스458은 2024년 설립된 동시대 예술 플랫폼으로, 예술이 머무는 장소를 넘어서 
                지속적으로 질문하고 움직이는 살아있는 공간입니다.
              </p>
              <p className="font-light">
                우리는 예술이 단순한 감상의 대상이 아닌, 사회와 개인의 변화를 이끄는 동력이라고 믿습니다. 
                이러한 철학 아래 장르나 경력의 경계를 두지 않고, 다양한 감각과 관점을 지닌 창작자들이 
                자유롭게 실험하고 교차할 수 있는 열린 공간을 지향합니다.
              </p>
              <p className="font-light">
                전시, 워크숍, 협업 프로젝트, 영상 스크리닝, 아트페어 등 다양한 프로그램을 통해 
                동시대 시각문화 속에서 발생하는 시대적 담론과 사회적 이슈들에 반응하고, 
                이곳에서 예술 커뮤니티의 활력과 작가들의 성장 여정은 시각 언어로 완성되며, 
                각자의 실험이 새로운 가능성으로 확장됩니다.
              </p>
              <p className="font-light">
                스페이스458은 단순한 갤러리가 아니라, 살아있는 예술 커뮤니티의 중심이자 
                그 가능성의 증거입니다. 예술을 통해 새로운 가능성을 탐구하고 싶은 모든 이들을 
                스페이스458로 초대합니다.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-light tracking-wider mb-6">운영 정보</h3>
              <div className="space-y-4 text-gray-700">
                ...
                <div>
                  <h4 className="font-light mb-2">입장료</h4>
                  <p className="text-sm font-light">무료 관람</p>
                </div>
                <div>
